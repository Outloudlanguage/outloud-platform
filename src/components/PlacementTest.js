 ...
 const handleSubmitExam = async () => {
  ...
  return (
    <div 
      ...
      style={{ 
        backgroundImage: `linear-gradient(to bottom right, rgba(7,11,25,0.95), rgba(7,11,25,0.85)), url("https://pub-4ca81ef087364b84a5b486b76cc2b72e.r2.dev/267655.jpeg")`, 
    ...
    >
      ...
      <div className="w-full max-w-4xl px-4 md:px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center py-10 z-10 relative">
          <img src="https://pub-4ca81ef087364b84a5b486b76cc2b72e.r2.dev/Header.png" alt="Outloud Logo" className="h-10 md:h-12 object-contain drop-shadow-md" />
        </div>
