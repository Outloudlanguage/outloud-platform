...
const renderAccounts = () => (
   ...
   <div className="col-span-3 flex flex-col gap-6 h-full">
        {/* CREATE CARD */}
        <div onClick={() => setIsProvisioningModalOpen(true)} className="flex-1 relative flex flex-col items-center justify-center cursor-pointer group p-6 rounded-[2rem] bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl bg-clip-padding isolate overflow-hidden [transform:translateZ(0)] [-webkit-mask-image:-webkit-radial-gradient(white,black)]">
          <img src="https://i.postimg.cc/ZKPVccsH/4(8).png" alt="Create" className="w-48 h-48 mb-4 object-contain group-hover:scale-110 transition-transform duration-300 drop-shadow-md relative z-10 will-change-transform" />
          <h3 className="text-white font-black text-xl md:text-2xl tracking-widest uppercase text-center relative z-10">Create</h3>
        </div>
        
        {/* STATISTICS CARD */}
        <div onClick={() => alert('Módulo de Estadísticas en construcción...')} className="flex-1 relative flex flex-col items-center justify-center cursor-pointer group p-6 rounded-[2rem] bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl bg-clip-padding isolate overflow-hidden [transform:translateZ(0)] [-webkit-mask-image:-webkit-radial-gradient(white,black)]">
          <img src="https://i.postimg.cc/sxd4PQpm/2(12).png" alt="Statistics" className="w-48 h-48 mb-4 object-contain group-hover:scale-110 transition-transform duration-300 drop-shadow-md relative z-10 will-change-transform" />
